...
{
    public class AuthTokenStore: IOpenIddictTokenStore<Token>
    {
        /// <summary>
        ...
        /// </summary>
        private DbSet<Authorization> Authorizations => Context.Set<Authorization>();

        /// <summary>
        /// Gets the database set corresponding to the <typeparamref name="AuthToken"/> entity.
        /// </summary>
        private DbSet<Token> Tokens => Context.Set<Token>();
        ...
        /// <inheritdoc/>
        public virtual async ValueTask<long> CountAsync<TResult>(Func<IQueryable<Token>, IQueryable<TResult>> query, CancellationToken cancellationToken)
        {
            if (query is null)
            {
        ...
        /// <inheritdoc/>
        public virtual async ValueTask CreateAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
        ...
        /// <inheritdoc/>
        public virtual async ValueTask DeleteAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual IAsyncEnumerable<Token> FindAsync(string subject, string client, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc/>
        public virtual IAsyncEnumerable<Token> FindAsync(
        ...
        /// <inheritdoc/>
        public virtual IAsyncEnumerable<Token> FindByApplicationIdAsync(string identifier, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc/>
        public virtual IAsyncEnumerable<Token> FindByAuthorizationIdAsync(string identifier, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(identifier))
            {
                throw new ArgumentException("The identifier cannot be null or empty.", nameof(identifier));
        ...
        /// <inheritdoc/>
        public virtual async ValueTask<Token?> FindByIdAsync(string identifier, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(identifier))
            {
                throw new ArgumentException("The identifier cannot be null or empty.", nameof(identifier));
        ...
        /// <inheritdoc/>
        public virtual async ValueTask<Token?> FindByReferenceIdAsync(string identifier, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(identifier))
            {
                throw new ArgumentException("The identifier cannot be null or empty.", nameof(identifier));
        ...
        /// <inheritdoc/>
        public virtual IAsyncEnumerable<Token> FindBySubjectAsync(string subject, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(subject))
            {
                throw new ArgumentException("The subject cannot be null or empty.", nameof(subject));
        ...
        /// <inheritdoc/>
        public virtual async ValueTask<string?> GetApplicationIdAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual async ValueTask<string?> GetAuthorizationIdAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<DateTimeOffset?> GetCreationDateAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<DateTimeOffset?> GetExpirationDateAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<string?> GetIdAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<string?> GetPayloadAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<ImmutableDictionary<string, JsonElement>> GetPropertiesAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<DateTimeOffset?> GetRedemptionDateAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<string?> GetReferenceIdAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<string?> GetStatusAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<string?> GetSubjectAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<string?> GetTypeAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask<Token> InstantiateAsync(CancellationToken cancellationToken)
        {
            try
            {
                return new ValueTask<Token>(Activator.CreateInstance<Token>());
            }

            catch (MemberAccessException exception)
            {
                return new ValueTask<Token>(Task.FromException<Token>(
        ...
        /// <inheritdoc/>
        public virtual IAsyncEnumerable<Token> ListAsync(int? count, int? offset, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc/>
        public virtual async ValueTask SetApplicationIdAsync(Token token, string? identifier, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual async ValueTask SetAuthorizationIdAsync(Token token, string? identifier, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetCreationDateAsync(Token token, DateTimeOffset? date, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetExpirationDateAsync(Token token, DateTimeOffset? date, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetPayloadAsync(Token token, string? payload, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetPropertiesAsync(Token token,
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetRedemptionDateAsync(Token token, DateTimeOffset? date, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetReferenceIdAsync(Token token, string? identifier, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetStatusAsync(Token token, string? status, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetSubjectAsync(Token token, string? subject, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual ValueTask SetTypeAsync(Token token, string? type, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));
        ...
        /// <inheritdoc/>
        public virtual async ValueTask UpdateAsync(Token token, CancellationToken cancellationToken)
        {
            if (token is null)
            {
                throw new ArgumentNullException(nameof(token));

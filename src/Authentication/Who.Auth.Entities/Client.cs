...
namespace Who.Auth.Entities
{
    ...
    { 
        ...
        /// </summary>
        public virtual ICollection<Authorization> Authorizations { get; } = new HashSet<Authorization>();
        ...
        /// </summary>
        public virtual List<ClientPostLogoutRedirectUri> PostLogoutRedirectUris { get; set; } = new();
        ...
        /// </summary>
        public virtual ICollection<Token> Tokens { get; } = new HashSet<Token>();
